                    ...
                    <div class="card card-signup text-center">
                        <div class="card-header ">
                            ...
                            <div class="social">
                                ...
                                <p class="card-description"><?php echo e(__('or be classical')); ?></p>
                            </div>
                        </div>
                        <div class="card-body ">
                            <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
                                ...
                                <div class="input-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="Name" value="<?php echo e(old('name')); ?>" required autofocus>
                                ...
                                <div class="input-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input name="email" type="email" class="form-control" placeholder="Email" required value="<?php echo e(old('email')); ?>">
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/proyek4/resources/views/auth/register.blade.php ENDPATH**/ ?>